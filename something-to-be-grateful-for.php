...
<body>
    <div class="themes">
        ...
        <?php
            ...
            $sql = "SELECT * FROM quotes WHERE quoteApproved = 0 AND quoteTheme = 'Something to be Grateful For' order by RAND() LIMIT 1";
        ...
        ?>
        <div class="button1">
            <p>See more things to be grateful for</p>
        </div>

        <div class="theme-forms">
            <form action="includes/something-to-be-grateful-for.inc.php" method="post">
                <input type="text" name="quote" placeholder="Enter something people should be grateful for..." maxlength="200">
...
<script>
    ...
    $(document).ready(function() {  
        $('.button1').click(function() {
            $.post('includes/random/random-something-to-be-grateful-for.inc.php',function(data){
                $('#quote').html(data);
                console.log("hello");
            });
        });
