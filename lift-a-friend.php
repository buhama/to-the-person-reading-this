...
<body>
    <div class="themes">
        ...
        <?php
            ...
            $sql = "SELECT * FROM quotes WHERE quoteApproved = 0 AND quoteTheme = 'Lift a Friend' order by RAND() LIMIT 1";
        ...
        ?>
        <div class="button1">
            <p>See more uplifting words</p>
        </div>

        <div class="theme-forms">
            <form action="includes/lift-a-friend.inc.php" method="post">
                <input type="text" name="quote" placeholder="Uplift a friend..." maxlength="200">
...
<script>
    ...
    $(document).ready(function() {  
        $('.button1').click(function() {
            $.post('includes/random/random-lift-a-friend.inc.php',function(data){
                $('#quote').html(data);
                console.log("hello");
            });
        });
