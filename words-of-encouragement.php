...
<body>
    <div class="themes">
        ...
        <?php
            ...
            $sql = "SELECT * FROM quotes WHERE quoteApproved = 0 AND quoteTheme = 'Words of Encouragement' order by RAND() LIMIT 1";
        ...
        ?>
        <div class="button1">
            <p>See more words of encouragement</p>
        </div>

        <div class="theme-forms">
            <form action="includes/words-of-encouragement.inc.php" method="post">
                <input type="text" name="quote" placeholder="Enter some words of encouragement..." maxlength="200">
...
<script>
    ...
    $(document).ready(function() {  
        $('.button1').click(function() {
            $.post('includes/random/randomencouragement.inc.php',function(data){
                $('#quote').html(data);
                console.log("hello");
            });
        });
